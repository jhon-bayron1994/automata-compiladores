...
class Automata:
    ...
    def validar(self,esfera, flecha, flecha3, flecha4, borde, esfera2, esfera3, flecha2, apuntador):
                    ...
                    if(self.estado_grafo == "inicial"):
                        ...
                        if(contador == 1):
                            ...
                            if(self.palabra[e] == self.pila.pila[len(self.pila.pila)-1].letra):
                                ...
                                self.estado == "rechazado"
                                self.lienzo.create_text(150,300,fill="green",font="arial 20",text="palabra rechazada")
                                print("rechazado")
                    else:
        ...
        if(contador_palabra == (len(self.palabra)/2)-0.5):
            ...
            self.lienzo.update()
            self.lienzo.create_text(150,300,fill="black",font="arial 20",text="palabra aceptada")
            print("aceptado")
